...
export default function Home() {
    ...
    //check balance of Crypto Dev Tokens held by address
    ...
    //withdraw ether and tokens by calling the function in the contract
    ...
    const renderButton = () => {
        ...
        if(walletConnected && isOwner) {
            return (
                <div>
                    <button className={styles.button1} onClick={withdrawCoins}>Withdraw Coins</button>
                </div>
            );
        }
